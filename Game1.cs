...
namespace ShadowMappingSample
{
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            shadowRenderTarget = new RenderTarget2D(_graphics.GraphicsDevice,
        ...
        void DrawShadowMapToScreen()
        {
            ...
            _spriteBatch.Draw(shadowRenderTarget, new Rectangle(0, 0, 128, 128), Color.White);
            _spriteBatch.End();
